...
import ListProductByCategories from "../../../components/client/ListProductByCategories";
import FilterProductByPrice from "../../../components/client/FilterProductByPrice";
  ...
  return (
    <section className="py-20 pt-0 bg-gray-50 font-poppins dark:bg-gray-800 ">
      <div className="banner">
        <Carousel autoplay>
          <img
            src="https://ai.moon.vn/images/img/910202242221PM.jpg"
            alt=""
          />
          <img
            src="https://png.pngtree.com/back_origin_pic/03/88/19/883f1b0ddd7c6f341e3357fd964b2bfa.jpg"
            alt=""
          />
          <img
            src="https://medinsights.vn/wp-content/uploads/2022/07/BANNNER-1-1024x379.png"
            alt=""
          />
          <img
            src="https://newshop.vn/public/uploads/options/s%C3%A1ch%20tham%20kh%E1%BA%A3o%20newshop.jpg"
            alt=""
          />
        </Carousel>
      </div>
